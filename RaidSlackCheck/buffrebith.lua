...
local spisokid={25898,48470,48162,48073,48169,43002,48938,48934,43017}
...
if rscbuffwhichtrack[nr]==1 then rscbuffwhichtrack[nr]=0 else rscbuffwhichtrack[nr]=1 end
...
if rscbuffcheckb[nr]==1 then rscbuffcheckb[nr]=0 else rscbuffcheckb[nr]=1 end
...
if #nicktable>0 then
	for yyy=1,#nicktable do
		...
		if UnitInRaid(nicktable[yyy]) and UnitIsDeadOrGhost(nicktable[yyy])==nil and UnitAffectingCombat(nicktable[yyy]) and (classs==nil or (classs and englishClass and classs~=englishClass)) then
			rscchatfiltimefunc()
				if classs then
