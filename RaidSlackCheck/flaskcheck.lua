...
if GetLocale() == "ruRU" or GetLocale() == "enEN" or GetLocale() == "enUS" or GetLocale() == "deDE" then
...
SendAddonMessage("RSCfs1", 50, "RAID")
	...
	rscchatsendreports(chat,stringa1, stringa11, stringa2, stringa21, stringa22, stringa3, stringa31, stringa32, stringa4, stringa41)
	end
end
...
if nn==2 then
	...
	if #rscignorzone>0 then
		for i=1,#rscignorzone do
			if rscignorzone[i]==GetRealZoneText() then
				rrr=1
				out ("|cff99ffffRaidSlackCheck|r - "..rsczonereport3.."|cff00ff00"..GetRealZoneText().."|r")
