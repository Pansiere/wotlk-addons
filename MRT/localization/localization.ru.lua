...
L.NoteHelpAdvPg = "глобальная фаза 4. Глобальная фаза — это количество фаз с начала боя, для боссов с чередованием фаз 1-2-1-2-... (в этом примере сработает только во второй раз во второй фазе)."
