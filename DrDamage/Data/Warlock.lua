...
--Player
	--Pyroclasm
	self.PlayerAura[GetSpellInfo(63245)] = { School = { ["Fire"] = true, ["Shadow"] = true }, Ranks = 3, Value = 0.02, ID = 63245 }
...
--Custom
	...
	self.PlayerAura[GetSpellInfo(23785)] = { School = { ["Fire"] = true, ["Shadow"] = true }, NoManual = true, ModType =
		function ( calculation, _, Talents )
			if calculation.school == "Fire" and GetSpellInfo(imp) or calculation.school == "Shadow" and GetSpellInfo(succubus) then
				calculation.dmgM = calculation.dmgM * (1 + (Talents["Master Demonologist (talent)"] or 0))
			end
		end
	}
	--Backdraft
	self.PlayerAura[GetSpellInfo(47258)] = { NoManual = true, ModType =
		function( calculation, _, Talents )
			if Talents["Backdraft (talent)"] then
				calculation.haste = calculation.haste * (1 + Talents["Backdraft (talent)"])
			end
		end
	}
	--Haunt
	self.TargetAura[GetSpellInfo(48181)] = { School = "Shadow", SelfCast = true, ID = 48181, Not = "Curse of Doom",  ModType =
	...
	--Shadow Embrace
	self.TargetAura[GetSpellInfo(32386)] = { School = "Shadow", SelfCast = true, ID = 32386, Apps = 3, Not = "Curse of Doom", ModType =
		function( calculation, ActiveAuras, Talents, _, apps )
			if Talents["Shadow Embrace (talent)"] then
				if calculation.spellName == "Drain Life" or calculation.spellName == "Drain Soul" then
					calculation.dmgM = calculation.dmgM * (1 + Talents["Shadow Embrace (talent)"] * apps)
				else
					calculation.dmgM_dot = calculation.dmgM_dot * (1 + Talents["Shadow Embrace (talent)"] * apps)
				end
			end
			if Talents["Soul Siphon"] then
				ActiveAuras["Soul Siphon"] = (ActiveAuras["Soul Siphon"] or 0) + 1
	...
	self.spellInfo = {
		...
		[GetSpellInfo(1454)] = { --DONE: Base OK, Increase OK, Coefficient OK
					["Name"] = "Life Tap",
					[0] = { School = { "Shadow", "Affliction", }, SPBonus = 0, BaseIncrease = 10, NoSchoolTalents= true, NoDPS = true, NoTooltip = true, NoAura = true, Unresistable = true, NoDownrank = true },
		...
		[GetSpellInfo(6229)] = { --DONE: Base OK, Increase OK, Coefficient OK, Downrank OK
					["Name"] = "Shadow Ward",
					[0] = { School = "Shadow", SPBonus = 0.806, NoSchoolTalents= true, NoDPS = true, NoNext = true, NoDPM = true, NoDoom = true, NoAura = true, Unresistable = true, },
		...
		[GetSpellInfo(18220)] = { --Base OK, Increase OK, Coefficient X
					["Name"] = "Dark Pact",
					[0] = { School = { "Shadow", "Affliction", }, SPBonus = 0.96, NoSchoolTalents= true, NoDPS = true, NoTooltip = true, NoAura = true, Unresistable = true, NoDownrank = true },
		...
		[GetSpellInfo(980)] = { --Base OK, Increase OK, Coefficient X
					["Name"] = "Curse of Agony",
	...
	--AFFLICTION
		...
		--Shadow Embrace
		[GetSpellInfo(32385)] = {	[1] = { Effect = 0.01, Spells = "All", ModType = "Shadow Embrace (talent)" }, },
		--Siphon Life
		...
		--Malediction
		[GetSpellInfo(32477)] = {	[1] = { Effect = 0.01, Spells = "All", Multiply = true },
									[2] = { Effect = 3, Spells = { "Unstable Affliction", "Corruption" }, ModType = "critPerc" }, },
		--Death's Embrace
		[GetSpellInfo(47198)] = {	[1] = { Effect = 1, Spells = "Shadow", ModType = "Death's Embrace", }, },
		--Pandemic
	...
	--DEMONOLOGY
		--Demonic Aegis
		[GetSpellInfo(30143)] = { 	[1] = { Effect = 0.02, Spells = "All", ModType = "Demonic Aegis" }, },
		--Master Demonologist
		[GetSpellInfo(23785)] = {	[1] = { Effect = 0.01, Spells = "All", ModType = "Master Demonologist (talent)" }, },
		--Molten Core
		...
		--Demonic Pact
		[GetSpellInfo(47236)] = {	[1] = { Effect = 0.02, Spells = "All" }, },
	--DESTRUCTION:
		...
		--Emberstorm
		[GetSpellInfo(17954)] = {	[1] = { Effect = 0.03, Spells = "Fire", Mod = { "Incinerate", 3, 16, "castTime", function(v,c,t) return (v+c*0.05-t*0.05) end }, },
		...
		--Backdraft
		[GetSpellInfo(47258)] = { 	[1] = { Effect = 0.1, Spells = { "Conflagrate", "Shadowburn", "Shadowflame", "Shadowfury" }, ModType = "Backdraft (talent)", }, },
		--Fire and Brimstone
