...
--ABILITIES
	...
	self.Calculation["Holy Shock"] = function( calculation )
		...
		if calculation.healingSpell and self:GetSetAmount( "T8 Holy" ) >= 2 then
			...
			calculation.extraName = (calculation.extraName and (calculation.extraName .. "+") or "") .. "2p T8"
		end
	end
