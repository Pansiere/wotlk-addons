...
--ABILITIES
	self.Calculation["Ice Lance"] = function( calculation, ActiveAuras )
		if (ActiveAuras["Frozen"] or ActiveAuras["Deep Freeze"]) then
			--Glyph of Ice Lance
			local bonus = self:HasGlyph(56377) and (self:GetLevels() > 0) and 1 or 0
	...
	self.Calculation["Fireball"] = function( calculation )
		--Glyph of Fireball
		if self:HasGlyph( 56368 ) then
			calculation.extraDotDmg = nil
			calculation.critPerc = calculation.critPerc + 5
		end
		if self:GetSetAmount("T9") >= 4 then
			calculation.critPerc = calculation.critPerc + 5
...
--Custom
	...
	--FROST
		[GetSpellInfo(116)] = {
					--DONE: BASE OK, INCREASE OK, COEFFICIENT OK, DOWNRANK OK
					["Name"] = "Frostbolt", --TODO: Remove 0.95 penalty
					[0] = { School = "Frost", castTime = 3, canCrit = true, SPBonus = (3/3.5) * 0.95, BaseIncrease = true, Downrank = 4 },
		...
		[GetSpellInfo(11426)] = {
					--DONE: BASE OK, INCREASE OK, COEFFICIENT OK, DOWNRANK OK
					["Name"] = "Ice Barrier",
					[0] = { School = "Frost", Cooldown = 30, SPBonus = 0.8053, NoSchoolTalents = true, NoNext = true, NoDPS = true, NoDoom = true, Unresistable = true, NoAura = true, NoDPM = true, BaseIncrease = true, Downrank = 6 },
		...
		[GetSpellInfo(31687)] = {
					...
					[0] = { School = "Frost", SPBonus = 5/6, Cooldown = 180, canCrit = true, NoNext = true, NoSchoolTalents = true, NoDownrank = true, NoManualRatings = true },
	...
	--ARCANE
		...
		[GetSpellInfo(1463)] = {
					--DONE: BASE OK, INCREASE OK, COEFFICIENT OK, DOWNRANK OK
					["Name"] = "Mana Shield",
					[0] = { School = "Arcane", SPBonus = 0.8053, NoSchoolTalents = true, NoDPS = true, NoNext = true, NoDPM = true, NoDoom = true, NoAura = true, Unresistable = true, Downrank = 7 },
		...
		[GetSpellInfo(6143)] = {
					--DONE: BASE OK, INCREASE OK, COEFFICIENT OK, DOWNRANK OK
					["Name"] = "Frost Ward",
					[0] = { School = "Frost", SPBonus = 0.8053, NoSchoolTalents = true, NoDPS = true, NoNext = true, NoDPM = true, NoDoom = true, NoAura = true, Unresistable = true, Downrank = 9 },
		...
		[GetSpellInfo(543)] = {
					--DONE: BASE OK, INCREASE OK, COEFFICIENT OK, DOWNRANK OK
					["Name"] = "Fire Ward",
					[0] = { School = "Fire", SPBonus = 0.8053, NoSchoolTalents = true, NoDPS = true, NoNext = true, NoDPM = true, NoDoom = true, NoAura = true, Unresistable = true, Downrank = 9 },
	...
	--ARCANE:
		...
		[GetSpellInfo(29447)] = {	[1] = { Effect = 0.04, Spells = { "Frostbolt", "Fireball", "Frostfire Bolt", "Arcane Missiles", "Arcane Blast", "Arcane Barrage" }, ModType = "Torment the Weak" }, },
	...
	--FIRE:
		...
		[GetSpellInfo(31656)] = { 	[1] = { Effect = 0.05, Spells = { "Fireball", "Frostfire Bolt" }, ModType = "SpellDamage" }, },
		--Burnout
