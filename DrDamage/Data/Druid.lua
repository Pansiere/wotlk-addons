	...
	self.Calculation["DRUID"] = function( calculation, ActiveAuras, Talents, spell, baseSpell )
		if calculation.healingSpell then
			...
			if not baseSpell.Melee or baseSpell.Melee and calculation.school ~= "Physical" then
				...
				if Talents["Master Shapeshifter"] and UnitBuff("player", bear) then
					calculation.dmgM = calculation.dmgM / (1 + Talents["Master Shapeshifter"])
				end
...
--ABILITIES
	self.Calculation["Attack"] = function( calculation, _, Talents )
		if Talents["Predatory Instincts"] and GetShapeshiftForm() == 3 then
	...
	self.Calculation["Swiftmend"] = function( calculation, ActiveAuras, Talents )
		...
		local healingTarget = calculation.healingTarget
		...
		if rej then
			...
			--BUG: Talents don't apply to base portion of rejuvenation swiftmend
			calculation.minDam = (12/(spell.eDuration or 12)) * spell[1] / (1 + calculation.dmgM_Add)
...
--Custom
	...
	self.spellInfo = {
		...
		[GetSpellInfo(48505)] = {
					--DONE: BASE OK, INCREASE OK, COEFFICIENT OK, DOWNRANK OK
					["Name"] = "Starfall",
					[0] = { School = "Arcane", canCrit = true, SPBonus = --[[0.37 * 10--]] 0.0458 * 10, ExtraSPBonus = --[[0.13--]] 0.012, eDot = true, eDuration = 10, sHits = 10, ExtraAoE = true, NoPeriod = true },
					[1] = { --[[144, 167, extraAoe = 25.5,--]] 111, 129, extraAoe = 20, spellLevel = 60, Downrank = 9 },
					[2] = { --[[324, 377, extraAoe = 57.5,--]] 250, 290, extraAoe = 45, spellLevel = 70, Downrank = 4 },
					[3] = { --[[474, 551, extraAoe = 84.5,--]] 366, 424, extraAoe = 66, spellLevel = 75, Downrank = 4 },
					[4] = { --[[562, 653, extraAoe = 100.5,--]] 433, 503, extraAoe = 78, spellLevel = 80, },
		},
		[GetSpellInfo(5185)] = {
					--DONE: BASE OK, INCREASE OK, COEFFICIENT OK, DOWNRANK OK
					["Name"] = "Healing Touch",
		...
		[GetSpellInfo(22568)] = {
					["Name"] = "Ferocious Bite",
					[0] = { Melee = true, ComboPoints = true, APBonus = 0.07, MaxPower = 30, PowerBonusAP = 1/410, requiresForm = 3 },
		...
		[GetSpellInfo(33831)] = {
					...
					[0] = { Melee = true, eDuration = 30, Cooldown = 180, Armor = true, Avoidable = true, NoParry = true, Glancing = true, MeleeHaste = true, CustomHaste = true, BaseHaste = 1, NoNext = true, NoManualRatings = true },
					[1] = { 454, 669 },
		},
	}
	self.talentInfo = {
