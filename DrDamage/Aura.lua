...
local function DrD_LoadAuras()
	...
	Aura[GetSpellInfo(34455)] = { Category = "+3% damage", Manual = GetSpellInfo(34455), ID = 34455, Multiply = true, Mods = { ["dmgM"] = 0.03 } }
	--Arcane Empowerment
	Aura[GetSpellInfo(31579)] = Aura[GetSpellInfo(34455)]
	--Sanctified Retribution	
		--Concentration
		Aura[GetSpellInfo(19746)] = { Category = "+3% damage", Manual = GetSpellInfo(31869), ID = 31869, Multiply = true, Mods = { ["dmgM"] = 0.03 } }
		--Retribution
	...
	--CORE
		...
		--Unrelenting Assault
		Aura[GetSpellInfo(64850)] = { School = "Spells", Value = -0.25, Ranks = 2, NoManual = true }
		--Moonkin Aura
	...
	if playerHybrid or playerMelee then
		...
		--Icy Talons
		Aura[GetSpellInfo(58578)] = { CustomHaste = true, Mods = { ["haste"] = function(v, baseSpell) return (baseSpell.WeaponDPS or baseSpell.NextMelee or baseSpell.MeleeHaste) and 1.2 * v or v end }, ID = 58578, Category = "+Meleehaste" }
	end
	...
	if playerHealer or playerCaster or playerHybrid then
		...
		Aura[GetSpellInfo(63277)] = { School = "Spells", ModType = function(calculation) calculation.dmgM = calculation.dmgM * (calculation.healingSpell and 0.25 or 2) end, NoManual = true, }
	end
...
--Debuffs
	...
	if playerHealer then
		...
		--Tree of Life
		Aura[GetSpellInfo(34123)] =  { School = "Healing", Caster = true, Category = "+6% Healing", ID = 34123,
			ModType = function( calculation, _, _, index, _, _, _, target )
				if not index or target and select(11,UnitBuff(target,index)) == 34123 then
	...
	--25% reduction
		...
		--Hopelessness
		Aura[GetSpellInfo(72390)] = Aura[GetSpellInfo(48291)]
	--50% reduction (Mortal Strike)
		...
		--Mortal Cleave (random mobs)
		Aura[GetSpellInfo(22859)] = Aura[GetSpellInfo(22859)]
	...
	--100% reduction
		...
		Aura[GetSpellInfo(59513)] = Aura[GetSpellInfo(55593)]
